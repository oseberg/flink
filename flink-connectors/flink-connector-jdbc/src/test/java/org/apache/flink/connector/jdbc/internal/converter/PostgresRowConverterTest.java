...
public class PostgresRowConverterTest {
	...
	public void testString() throws Exception {
		...
		rowFields.add(new RowField(
				"string",
				DataTypes.VARCHAR(Integer.MAX_VALUE).notNull().getLogicalType()));
	...
	public void testArray() throws Exception {
		...
		rowFields.add(new RowField(
				"array",
				DataTypes.ARRAY(DataTypes.VARCHAR(Integer.MAX_VALUE).notNull()).notNull().getLogicalType()));
		RowType rowType = new RowType(rowFields);
		PostgresRowConverter converter = new PostgresRowConverter(rowType);
	...
	public void testNullArray() throws Exception {
		...
		rowFields.add(new RowField(
				"nullableArray",
				DataTypes.ARRAY(DataTypes.VARCHAR(Integer.MAX_VALUE).notNull()).nullable().getLogicalType()));
		RowType rowType = new RowType(rowFields);
		PostgresRowConverter converter = new PostgresRowConverter(rowType);
